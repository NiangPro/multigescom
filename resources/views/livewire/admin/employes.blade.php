<div>
  <button  wire:click.prevent="changeEtat()"  class="btn btn-success mb-2" >@if($etat==="list")<i class="fa fa-plus" aria-hidden="true"></i> Ajout @else<i class="fa fa-list" aria-hidden="true"></i> Liste @endif</button>
    @if ($etat === "list")
      @if ($showDiv)
        <div class="container col-sm-6 text-center alert alert-warning alert-dismissible fade show" role="alert">
          <strong>Voulez-vous reélement supprimer <span style="color: black;">Alioune Fall ?</span></strong>
          <span class="float-right mt-n1">
            <button wire:click.prevent="deleteEmploye({{$this->form['id']}})" class="btn btn-success btn-sm">Oui</button>&nbsp;&nbsp;                              
              ...
              <div class="card author-box card-primary">
                <div class="card-body">
                  <div class="author-box-left">
                    ...
                    <button type="button" wire:click.prevent="openDiv()" class="btn btn-outline-danger btn-sm btn-rounded">
