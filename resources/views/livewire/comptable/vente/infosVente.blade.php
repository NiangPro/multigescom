    ...
    <div class="card-body container mt-0" id="detailsVente">
        ...
        <div class="table-responsive-sm">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($current_vente->ventes_items as $produit)
                        <tr>
                            <td class="left strong">{{$produit['nom']}}</td>
                            <td class="left">{{$produit['description']}}</td>
                            <td class="right">{{$produit['montant']}} CFA</td>
                            <td class="center">{{$produit['quantite']}}</td>
                            <td class="right">{{$this->mtHt*$produit['quantite']}} CFA</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
