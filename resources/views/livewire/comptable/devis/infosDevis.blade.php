    ...
    <div class="card-body container mt-0" id="detailsDevis">
        ...
        <div class="table-responsive-sm">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($current_devis->devis_items as $devis)
                        <tr>
                            <td class="left strong">{{$devis['nom']}}</td>
                            <td class="left">{{$devis['description']}}</td>
                            <td class="right">{{$devis['montant']}} CFA</td>
                            <td class="center">{{$devis['quantite']}}</td>
